...
extern pascal AEFilterProcType_ 	(*gAEIdleProc) ( EventRecord *theEvent, long *sleepTime, 
				RgnHandle *mouseRgn);
extern pascal AEFilterProcType_ 	(*gAEFilterProc) (EventRecord *theEvent, long returnID, 
...
enum {						/* pieces */ 
	...
	BPAWN, BROOK, BKNIGHT, BBISHOP, BQUEEN, BKING, NPIECE 
	};
